...
/// Encoder::update_cyclers_ @ 0x4E6CA0. A value is eligible only when its
...
/// Construct path @ 0x4E2xxx LABEL_91: all five period dwords receive
...
/// ADOL 0x64 packs the first three bytes as BE 0x030306.
inline constexpr std::uint32_t kConstructDefaultEncoderVersion = 0x00030306u;

/// Native construct LABEL_91 forces Encoder+6232 to signed -1659869902.
...
/// Construct LABEL_91 payload/cursor defaults after periods are installed:
