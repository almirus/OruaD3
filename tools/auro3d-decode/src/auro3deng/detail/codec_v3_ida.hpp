...
// Native x86-64 Upmix_t_construct @ 0x4CF330 lifecycle slots.
constexpr std::uintptr_t kAuroA3dengV3PipelineStepUpmix_configure = 0x4CF440;
constexpr std::uintptr_t kAuroA3dengV3PipelineStepUpmix_reset = 0x4CF650;
constexpr std::uintptr_t kAuroA3dengV3PipelineStepUpmix_update = 0x4CF660;
// Native x86-64 Upmix_t_construct @ 0x4CF330 lifecycle slots.
constexpr std::uintptr_t kAuroA3dengV3PipelineStepUpmix_configure = 0x4CF440;
constexpr std::uintptr_t kAuroA3dengV3PipelineStepUpmix_reset = 0x4CF650;
constexpr std::uintptr_t kAuroA3dengV3PipelineStepUpmix_update = 0x4CF660;
...
constexpr std::uintptr_t kStepUpmixGain_process = 0x35CE60;
constexpr std::uintptr_t kStepUpmixSilence_process = 0x35D210;
constexpr std::uintptr_t kStepUpmixFrontManagerInput_process = 0x35AF60;
constexpr std::uintptr_t kStepUpmixInput_process = 0x35AAA0;
constexpr std::uintptr_t kStepUpmix3D3D_process = 0x35C650;
constexpr std::uintptr_t kStepUpmixFrontManagerOutput_process = 0x35CA90;
constexpr std::uintptr_t kStepHeadroom_process = 0x356160;
constexpr std::uintptr_t kStepGate_process = 0x363EB0;
// Current v3 Manager constructor lifecycle slots for the simple pipeline
// steps. These are recorded separately from process tokens because the
// constructor writes different callbacks at +0/+8/+16/+24.
constexpr std::uintptr_t kStepSampleConvertor_configure = 0x4CF840;
constexpr std::uintptr_t kStepSampleConvertor_update = 0x4CF920;
constexpr std::uintptr_t kStepSampleConvertor_reset = 0x4CF910;
constexpr std::uintptr_t kStepUpSample_configure = 0x4CF700;
constexpr std::uintptr_t kStepUpSample_update = 0x4CF7F0;
constexpr std::uintptr_t kStepUpSample_process = 0x4CF760;
constexpr std::uintptr_t kStepUpSample_reset = 0x4CF7E0;
constexpr std::uintptr_t kStepHeadroom_configure = 0x4D1440;
constexpr std::uintptr_t kStepHeadroom_update = 0x4D1B70;
constexpr std::uintptr_t kStepHeadroom_process_smooth = 0x4D1850;
constexpr std::uintptr_t kStepHeadroom_process_direct = 0x4D1470;
constexpr std::uintptr_t kStepGate_configure = 0x4D1BB0;
constexpr std::uintptr_t kStepGate_update = 0x4D1EC0;
constexpr std::uintptr_t kStepGate_process_current = 0x4D1BE0;
constexpr std::uintptr_t kStepGate_reset = 0x4D1EB0;
constexpr std::uintptr_t kStepDelay_configure = 0x4D5460;
constexpr std::uintptr_t kStepDelay_update = 0x4D5E20;
constexpr std::uintptr_t kStepDelay_process = 0x4D5900;
constexpr std::uintptr_t kStepDelay_reset = 0x4D5CA0;
constexpr std::uintptr_t kStepDownSample_configure = 0x4D22E0;
constexpr std::uintptr_t kStepDownSample_update = 0x4D23D0;
constexpr std::uintptr_t kStepDownSample_process = 0x4D2340;
constexpr std::uintptr_t kStepDownSample_reset = 0x4D23C0;
constexpr std::uintptr_t kStepLegacy_configure = 0x4D5E90;
constexpr std::uintptr_t kStepLegacy_update = 0x4D6060;
constexpr std::uintptr_t kStepLegacy_process = 0x4D5ED0;
constexpr std::uintptr_t kStepLegacy_reset = 0x4D6050; // nullsub_47
constexpr std::uintptr_t kStepAlt3DStore_configure = 0x4D4000;
constexpr std::uintptr_t kStepAlt3DStore_update = 0x4D4230;
constexpr std::uintptr_t kStepAlt3DStore_process = 0x4D4070;
constexpr std::uintptr_t kStepAlt3DStore_reset = 0x4D4220;
constexpr std::uintptr_t kStepBassManagement_configure = 0x4D2460;
constexpr std::uintptr_t kStepBassManagement_update = 0x4D2640;
constexpr std::uintptr_t kStepBassManagement_process = 0x4D24B0;
constexpr std::uintptr_t kStepBassManagement_reset = 0x4D2630;
constexpr std::uintptr_t kStepDownmix_configure = 0x4D1F30;
constexpr std::uintptr_t kStepDownmix_update = 0x4D2120;
constexpr std::uintptr_t kStepDownmix_process = 0x4D1F90;
constexpr std::uintptr_t kStepDownmix_reset = 0x4D2110;
constexpr std::uintptr_t kStepScene_configure = 0x4D26F0;
constexpr std::uintptr_t kStepScene_update = 0x4D3440;
constexpr std::uintptr_t kStepScene_process = 0x4D31E0;
constexpr std::uintptr_t kStepScene_reset = 0x4D3580;
constexpr std::uintptr_t kStepHeadphones_configure = 0x4D36E0;
constexpr std::uintptr_t kStepHeadphones_update = 0x4D3880;
constexpr std::uintptr_t kStepHeadphones_process = 0x4D3730;
constexpr std::uintptr_t kStepHeadphones_reset = 0x4D3870;
constexpr std::uintptr_t kStepAlt3DMix_configure = 0x4D4370;
constexpr std::uintptr_t kStepAlt3DMix_update = 0x4D4540;
constexpr std::uintptr_t kStepAlt3DMix_process = 0x4D43A0;
constexpr std::uintptr_t kStepAlt3DMix_reset = 0x4D4530; // nullsub_46
constexpr std::uintptr_t kStepSilence_configure = 0x4D4DD0;
constexpr std::uintptr_t kStepSilence_update = 0x4D4F80;
constexpr std::uintptr_t kStepSilence_process = 0x4D4E00;
constexpr std::uintptr_t kStepSilence_reset = 0x4D4F90;
constexpr std::uintptr_t kStepPeakLimiter_configure = 0x4D4FD0;
constexpr std::uintptr_t kStepPeakLimiter_update = 0x4D5410;
constexpr std::uintptr_t kStepPeakLimiter_process = 0x4D5330;
constexpr std::uintptr_t kStepPeakLimiter_reset = 0x4D5400;
constexpr std::uintptr_t kStepChannelTest_configure = 0x4D60E0;
constexpr std::uintptr_t kStepChannelTest_update = 0x4D6400;
constexpr std::uintptr_t kStepChannelTest_process = 0x4D6150;
constexpr std::uintptr_t kStepChannelTest_reset = 0x4D6440; // nullsub_48
constexpr std::uintptr_t kStepGate_process = 0x363EB0;
constexpr std::uintptr_t kStepUpmixGain_process = 0x35CE60;
constexpr std::uintptr_t kStepUpmixSilence_process = 0x35D210;
constexpr std::uintptr_t kStepUpmixFrontManagerInput_process = 0x35AF60;
